...
class GMChatTwoTableView: UITableView{
    //设置NSTime定时器
...
extension GMChatTwoTableView: UIScrollViewDelegate {
...
//代理
extension GMChatTwoTableView:UITableViewDelegate, UITableViewDataSource {
